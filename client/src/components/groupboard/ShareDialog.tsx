    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">Share this board</h2>
        ...
        <div className="space-y-4">
          <div>
            <label className="text-sm text-muted-foreground block mb-1.5">Share code</label>
            <div className="text-3xl font-mono font-bold tracking-wider text-center py-3 bg-muted rounded-lg">
              {shareCode}
            </div>
          </div>

          <div>
            <label className="text-sm text-muted-foreground block mb-1.5">Or copy link</label>
          ...
          {typeof navigator.share === "function" && (
            <button
              ...
              className="w-full py-2.5 bg-secondary text-secondary-foreground rounded-lg text-sm font-medium hover:bg-secondary/80 transition-colors"
            >
              Share via...
            </button>
          )}
